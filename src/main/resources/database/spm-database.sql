...
(
  ...
  INDEX `fk_exam_has_selected_course_selected_course1_idx` (`selected_course_student_user_id` ASC,
                                                            `selected_course_course_course_id` ASC),
